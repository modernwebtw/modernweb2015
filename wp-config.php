 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         't*_x>/ERc23@XVx/m~gAG#P^tPs>5g#pm$/,zu:u=7TKQf3iuLOh9nT`:/Xviu/R');
define('SECURE_AUTH_KEY',  'j,>7p9:4j#]KYV^bN7|~pt+%xs<Y{#h0IZ+$;CNoGQtILJ&-BUqDf+/P|TKuR}.E');
define('LOGGED_IN_KEY',    '8sfj?ti=%<-r~oak+w(#-ieT?)9PBqP3zRt`(->5X+|h^ j;kMZ+H|{.0,w?_+y^');
define('NONCE_KEY',        'DLjG_c/71YAQl3Ica!.sXY$v-$E!Wj=Tz=)on.n7=ndg%X$|o$:e2JM/v^tn%enX');
define('AUTH_SALT',        'VN:7@3<72juh;i@>YUhu%W /[CZ4msZ.M;>>qF|5JdEp]=3:w(D3o;.&1HraLzRH');
define('SECURE_AUTH_SALT', '`1D2p[#sgP;x-H<vjBM8uFX)7/EKRX3&vl8pUJJ-z/IE;jRqga*+1K(YEL|/5tSw');
define('LOGGED_IN_SALT',   '+H?iCEzgk$Qu=_MAgWn<Xe?R5lI$%tfr7$R/V=1xkJLlkm-6XIc>N/g|wiabW+]Z');
define('NONCE_SALT',       '<+_UP^y{j&8f:v4:Ih=~rQy|qu|IRa-P4f}`N$+jVLTb]d8Ax=3yw:J>(GRDa[K7');
